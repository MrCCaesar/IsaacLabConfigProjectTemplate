...
All the environments are registered in the `IsaacLabConfigProjectTemplate` extension. They start
...
import IsaacLabConfigProjectTemplate.tasks  # noqa: F401


def main():
    """Print all environments registered in `IsaacLabConfigProjectTemplate` extension."""
