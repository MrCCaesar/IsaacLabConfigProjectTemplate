...
def some_public_function(x: int):
    print("[IsaacLabConfigProjectTemplate] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[IsaacLabConfigProjectTemplate] startup")
    ...
    def on_shutdown(self):
        print("[IsaacLabConfigProjectTemplate] shutdown")