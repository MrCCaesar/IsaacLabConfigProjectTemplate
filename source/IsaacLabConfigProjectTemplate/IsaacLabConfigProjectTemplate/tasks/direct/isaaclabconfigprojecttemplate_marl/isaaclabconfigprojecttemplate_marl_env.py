...
from .isaaclabconfigprojecttemplate_marl_env_cfg import IsaaclabconfigprojecttemplateMarlEnvCfg


class IsaaclabconfigprojecttemplateMarlEnv(DirectMARLEnv):
    cfg: IsaaclabconfigprojecttemplateMarlEnvCfg

    def __init__(self, cfg: IsaaclabconfigprojecttemplateMarlEnvCfg, render_mode: str | None = None, **kwargs):
